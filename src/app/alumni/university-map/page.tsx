        ...
        <div className="mt-8">
          ...
          {loading && (
            <div className="space-y-6">
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="animate-pulse rounded-2xl border border-gray-250 bg-gray-50 p-5">
          ...
          {data && data.cities.length > 0 && (
            <>
              ...
              {/* Map */}
              <div className="mt-6 overflow-hidden rounded-2xl border border-brand/10 shadow-sm bg-white">
                <CityMapRenderer cities={data.cities} />
                <div className="flex items-center gap-2 border-t border-brand/10 bg-white/80 px-4 py-3">
